...
# Spec de documentacao: alimenta o swagger/v1/swagger.yaml servido em /api-docs.
# As asseracoes de comportamento ficam em spec/requests/api/v1/users_spec.rb.
# O subdominio 'api' exigido pelas rotas vem do host! global no rails_helper.
